...
class Cliente(Base):
    ...
    FechaCreacion = Column(TIMESTAMP, server_default="CURRENT_TIMESTAMP", nullable=False)
    FechaActualizacion = Column(TIMESTAMP, server_default="CURRENT_TIMESTAMP", onupdate="CURRENT_TIMESTAMP", nullable=False)
